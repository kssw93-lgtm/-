...
const LOVE_DEEP_DIVE = loveDeepDiveJson as Record<PatternGroup, Record<Strength, LoveDeepDive>>;
 ...
 */
export function getLoveDeepDive(group: PatternGroup, strength: Strength): LoveDeepDive {
  return LOVE_DEEP_DIVE[group][strength];
}
