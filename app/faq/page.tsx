...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "격국과 평생 대운 흐름도 결과 화면에서 무료로 확인할 수 있어요. 결과를 보거나 상세 내용을 펼치기 위해 광고를 시청할 필요는 없어요. 일부 해설 페이지에는 광고가 표시될 수 있어요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "사주달력은 사주 계산 기능과 별개로 전체 78장(메이저 아르카나 22장 + 마이너 아르카나 56장)의 상징·키워드·연애·금전·직업·건강운 풀이를 담은 타로 백과사전(/tarot-guide)도 함께 제공해요.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "로그인이나 회원가입은 없지만, 자신의 출생 입력은 재입력을 줄이기 위해 이 브라우저의 로컬 저장소에 남을 수 있어요. 사주 계산 서버로 전송하는 기능은 없으며, 결과의 '다른 사람 정보로 보기' 또는 개인정보처리방침의 삭제 버튼으로 지울 수 있어요.",
  },
];
