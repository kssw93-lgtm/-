  ...
  return (
    <div className="flex flex-1 flex-col gap-6 px-6 py-8">
      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-[color:var(--color-gold)]/20 bg-white/5 p-5 text-[15px] leading-relaxed text-white/85">
        ...
        <p>
          <strong className="text-[color:var(--color-gold-light)]">무료로 운영하는 대신 광고가 포함될 수 있어요.</strong>{" "}
          운영비를 위한 Google 애드센스 연결 코드가 있으며, 실제 게재 여부는 심사와 광고 공급 상태에 따라 달라져요.
          결과와 부적 카드는 광고 시청이나 클릭 없이 확인할 수 있어요.
        </p>
        <p>
        ...
        <p>
          풀이와 교육 글은 AI 작성 보조를 포함해 제작한 설명 콘텐츠예요. 계산 규칙에 따른 출력 확인과 사람의
          경험·미래를 맞히는 것은 다르며, 명리 전문가의 감수나 개인별 상담을 받은 결과로 표시하지 않아요. 오류가
          확인되면 계산 기준과 설명을 구분해 수정해요.
        </p>
